...
use App\Service\Parser\TilePorcelainMosaicParser;
...
#[AsCommand(
    name: 'app:parser:tiles-porcelain-mosaic',
    description: 'Parses LemanaPro tile, porcelain stoneware and mosaic products into the catalog.'
)]
final class TilePorcelainMosaicParserCommand extends Command
{
    public function __construct(
        private readonly TilePorcelainMosaicParser $parser,
    ...
    {
        $this
            ->addArgument('url', InputArgument::OPTIONAL, 'Catalog URL to start parsing from.', TilePorcelainMosaicParser::DEFAULT_URL)
            ->addArgument('category', InputArgument::OPTIONAL, 'Category id or exact category name.', TilePorcelainMosaicParser::CATEGORY_NAME)
    ...
    protected function execute(InputInterface $input, OutputInterface $output): int
    {
        ...
        $io->success(sprintf(
            'Tile, porcelain stoneware and mosaic parser completed. Category: %s. Created: %d. Updated: %d.',
            $category->getName(),
            $created,
            $updated
        ));
